...
export default function R2N({ onSelect }) {
    const [manufacturers, setManufactures] = useState([
        { name: '알티마', img: '/Nissan/알티마.PNG', select: false },
        { name: '로그', img: '/Nissan/로그.PNG', select: false },
        { name: '리프', img: '/Nissan/리프.PNG', select: false },
    ]);
